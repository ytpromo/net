...
const faqs = [
  ...
  },
  {
    ...
    answer:
      'در تمام پلن‌ها می‌توانید دامنه اختصاصی، SSL دلخواه و استایل سازمانی را اعمال کنید تا تجربه یکپارچه‌ای برای کاربران بسازید.',
  },
  {
    question: 'چگونه می‌توان دسترسی تیم را مدیریت کرد؟',
    answer:
      'با نقش‌های مبتنی بر سطح دسترسی، SSO، LDAP و احراز هویت چندعاملی کنترل کامل روی کاربران و گروه‌ها خواهید داشت.',
  },
  {
    question: 'نام تم‌های قیمت‌گذاری چه معنایی دارند؟',
    answer:
      'نام تم‌ها صرفاً برای سرگرمی هستند و تفاوتی در امکانات یا قیمت واقعی پلن‌ها ایجاد نمی‌کنند؛ سناریوهای زیرساختی ثابت می‌مانند.',
  },
]
