...
const faqs = [
  ...
  {
    question: 'آیا امکان ادغام با سیستم حراز هویت سازمانی وجود دارد؟',
    answer:
  ...
  {
    question: 'چه امکانات امنیتی روی سرویس فعال است؟',
    answer:
      'SSL اختصاصی، فایروال نرم‌افزاری، محدودیت IP و لاگ کامل فعالیت‌ها به صورت پیش‌فرض فعال هستند و می‌توان سیاست‌ها را سفارشی کرد.',
  },
]
